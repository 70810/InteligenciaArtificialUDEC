	...
	function percePersonaje()
	{
		...
		*/
		...
		if(muere == 0)
		{
			...
			if(llevaOro && (posPersonaje[0] == mundosWumpus[mundo].posAventurero[0] && posPersonaje[1] == mundosWumpus[mundo].posAventurero[1])) // validacion de cuando gana
			{
		...
		else
		{
			...
			if(muere == 1)//Avismo..
			{
				audios("callendo.mp3");//sonido cuando cae al avismo
				estilo = "avismo";
				txtPercibe = " <b><font color = 'blue'>El aventurero a muerto, cayó en un avismo...<font></b>";
			}
			else
			{
				audios("comiendo.mp3");//somido cuando se lo comen
				estilo = "piso";
